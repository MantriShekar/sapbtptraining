...
import { collection, keyAlone, list, PRIMITIVE_VALUE_ATTRIBUTE_NAMES, stringLiteral, struct, valuePair } from './primitives.js';
/**
 ...
 */
export function printEdmJson(node, options) {
