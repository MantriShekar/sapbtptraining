import { copyRange, ANNOTATION_TYPE, nodeRange, EMPTY_VALUE_TYPE, ReservedProperties } from '@sap-ux/cds-annotation-parser';
...
function convert(state, annotation) {
    ...
    element.attributes[Edm.Term] = createTermAttribute(termName, getTermNameRange(state, annotation, isEmbeddedAnnotation));
    ...
    if (annotation.qualifier) {
        element.attributes[Edm.Qualifier] = createQualifierAttribute(annotation.qualifier.value, nodeRange(annotation.qualifier, false));
    }
    if (annotation.value) {
