import { PATH_TYPE, nodeRange, copyRange, copyPosition, IDENTIFIER_TYPE, SEPARATOR_TYPE } from '@sap-ux/cds-annotation-parser';
import { createElementNode, createTextNode, Range, Edm, DiagnosticSeverity, ODATA_PATH_SEPARATOR_RULE, COMMON_CASE_ISSUE } from '@sap-ux/odata-annotation-core-types';
import { i18n } from '../../../i18n.js';
import { pathLikeTypeElementName } from '../path-utils.js';
export const pathHandler = {
    type: PATH_TYPE,
    convert(state, node) {
        const elementName = (state.context.valueType ? pathLikeTypeElementName(state.context.valueType) : undefined) ?? Edm.Path;
