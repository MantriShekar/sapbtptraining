 ...
 */
export function getImplicitPropertyType(vocabularyService, context, propertyName) {
    let baseType;
 ...
 */
export function getPropertyType(vocabularyService, recordType, propertyName) {
    if (!recordType) {
        return undefined;
    }
 ...
 */
export function getFullyQualifiedType(service, type) {
 ...
 */
export function getTerm(vocabularyService, vocabularyNameOrAlias, termName) {
