 ...
 */
export function convertFlattenedPath(state, segments, value) {
 ...
 */
function handleEmbeddedAnnotationSegment(state, segments, i, propertyRange, expandedStructure) {
...
function convertToExpandedStructure(state, segments, value) {
    ...
    while (i < segments.length) {
        ...
        if (segment.value === ReservedProperties.Type) {
            ...
            const flatProperty = createElementNode({
