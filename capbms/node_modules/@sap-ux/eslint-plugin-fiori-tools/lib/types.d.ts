 ...
 * @internal
 */
export type FioriRuleDefinitionInternal<Options extends Partial<CustomRuleTypeDefinitions> = object> = CustomRuleDefinitionType<{
 ...
 * @template Options - Optional rule configuration type definitions
 */
export type FioriRuleDefinition<Options extends Partial<CustomRuleTypeDefinitions> = object> = FioriRuleDefinitionInternal<Options> & RuleDefinition;
