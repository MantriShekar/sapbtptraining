...
import { ANNOTATION_FILE_TYPE, ATTRIBUTE_TYPE, ELEMENT_TYPE, NAMESPACE_TYPE, REFERENCE_TYPE, TARGET_TYPE, TEXT_TYPE } from '@sap-ux/odata-annotation-core';
...
export class FioriAnnotationSourceCode extends TextSourceCodeBase {
    ...
    traverse() {
        ...
        const visit = (node, parent) => {
            steps.push(new AnnotationVisitNodeStep({
                target: node,
