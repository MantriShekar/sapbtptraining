...
import { AnnotationVisitNodeStep } from './traversal-step.js';
...
export declare const visitorKeys: {
    [K in AnyNode['type']]: (keyof Extract<AnyNode, {
        type: K;
    }>)[];
};
/**
 ...
 */
export declare class FioriAnnotationSourceCode extends TextSourceCodeBase {
