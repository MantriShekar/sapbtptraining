 ...
 */
export declare class DiagnosticCache {
    /**
     ...
     */
    static getMessages<T extends Diagnostic['type']>(uri: string, ruleType: T): Extract<Diagnostic, {
        type: T;
    }>[] | undefined;
    /**
     ...
     */
    static addMessage<T extends Diagnostic['type']>(uri: string, ruleType: T, diagnostic: Extract<Diagnostic, {
        type: T;
    }>): void;
    /**
     ...
     */
    static addMessages<T extends Diagnostic['type']>(uri: string, ruleType: T, diagnostics: Extract<Diagnostic, {
        type: T;
    }>[]): void;
    /**
     ...
     */
    static clear(uri: string): void;
}
//# sourceMappingURL=diagnostic-cache.d.ts.map