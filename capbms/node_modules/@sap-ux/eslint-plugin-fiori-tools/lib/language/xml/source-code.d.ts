...
import { XMLVisitNodeStep } from './traversal-step.js';
...
export declare const visitorKeys: {
    [K in XMLAstNode['type']]: (keyof Extract<XMLAstNode, {
        type: K;
    }>)[];
};
/**
 ...
 */
export declare class FioriXMLSourceCode extends TextSourceCodeBase {
 ...
 */
export declare function isNode(node: XMLAstNode | XMLToken): node is XMLAstNode;
