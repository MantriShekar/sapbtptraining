...
const rule = createFioriRule({
    ...
    meta: {
        ...
        messages: {
            [TABLE_COLUMN_VERTICAL_ALIGNMENT]: '"tableColumnVerticalAlignment" for Responsive tables must be set to "Middle" - the default value'
        },
        fixable: 'code'
    },
    check(context) {
