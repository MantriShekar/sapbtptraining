...
const rule = {
    ...
    create(context) {
         ...
         * @param elements
         */
        function hasInterestingContentMethods(elements) {
            for (const element of elements) {
                if (isNewExpression(element)) {
                    const calleeNewExpression = element.callee;
                    if (isMember(calleeNewExpression) &&
         ...
         * @param properties
         */
        function hasContentWithInterestingMethods(properties) {
         ...
         * @param args
         */
        function hasArgumentsWithInterestingContent(args) {
         ...
         * @param node
         */
        function hasInterestingMethodsPattern(node) {
         ...
         * @param elements
         */
        function hasPropertyElementsWithInterestingMethods(elements) {
            for (const element of elements) {
                if (isNewExpression(element)) {
         ...
         * @param properties
         */
        function hasPropertiesWithInterestingNames(properties) {
            for (const prop of properties) {
         ...
         * @param args
         */
        function hasArgumentsWithInterestingPropertyNames(args) {
            for (const arg of args) {
                if (isObjectExpression(arg)) {
         ...
         * @param node
         */
        function hasInterestingPropertyNamesPattern(node) {
            const callee = node.callee;
...
export default rule;
//# sourceMappingURL=sap-ui5-forms.js.map