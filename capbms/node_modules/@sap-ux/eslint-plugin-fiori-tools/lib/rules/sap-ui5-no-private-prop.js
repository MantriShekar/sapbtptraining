 ...
 */
import { isIdentifier, isCall, startsWith, contains, getIdentifierPath, resolveIdentifierPath, createVariableDeclaratorProcessor, hasUnderscore } from '../utils/helpers.js';
// ------------------------------------------------------------------------------
// Rule Disablement
// ------------------------------------------------------------------------------
// ------------------------------------------------------------------------------
...
const rule = {
    meta: {
        type: 'problem',
        docs: {
            description: 'Check "sap-ui5-no-private-prop" should detect the usage of private properties and functions of UI5 elements',
            recommended: false
        },
        messages: {
    ...
    create(context) {
        ...
        const customNS = context.options[0]?.ns ?? [];
        const configuration = {
            'ns': uniquifyArray([
                'sap.ui.core',
                'sap.apf',
...
export default rule;
//# sourceMappingURL=sap-ui5-no-private-prop.js.map