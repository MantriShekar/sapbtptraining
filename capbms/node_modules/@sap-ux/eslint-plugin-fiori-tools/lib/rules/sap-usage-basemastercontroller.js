...
const rule = {
    meta: {
        ...
        messages: {
            basemastercontroller: "Usage of deprecated 'BaseMasterController' detected. Please use 'ScfldMasterController' instead."
        },
        schema: []
    },
    create(context) {
...
export default rule;
//# sourceMappingURL=sap-usage-basemastercontroller.js.map