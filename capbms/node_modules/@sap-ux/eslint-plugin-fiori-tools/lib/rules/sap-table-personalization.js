import { TABLE_PERSONALIZATION } from '../language/diagnostics.js';
...
const rule = createFioriRule({
    ...
    meta: {
        ...
        messages: {
            [TABLE_PERSONALIZATION]: 'Table personalization should be enabled. Currently every{{sectionText}} table personalization setting is disabled.',
