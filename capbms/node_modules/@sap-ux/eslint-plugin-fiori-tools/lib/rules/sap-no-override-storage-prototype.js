...
const rule = {
    meta: {
        ...
        messages: {
            overrideStoragePrototype: 'Storage prototype should not be overridden as this can lead to unpredictable errors'
        },
        schema: []
    },
    create(context) {
        const FORBIDDEN_STR_OBJECT = [];
        const MEMBER = 'MemberExpression', IDENTIFIER = 'Identifier';
        // --------------------------------------------------------------------------
        // Helpers
        // --------------------------------------------------------------------------
        /**
...
export default rule;
//# sourceMappingURL=sap-no-override-storage-prototype.js.map