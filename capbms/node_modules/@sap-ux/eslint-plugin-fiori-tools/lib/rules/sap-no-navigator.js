...
const rule = {
    ...
    create(context) {
        const FORBIDDEN_NAVIGATOR_WINDOW = ['javaEnabled'], FORBIDDEN_GLOB_EVENT = [
            'onload',
            'onunload',
            'onabort',
            'onbeforeunload',
        ...
        function isNavigator(node) {
            ...
            return ((isIdentifier(node) && node && 'name' in node && node.name === 'navigator') ||
...
export default rule;
//# sourceMappingURL=sap-no-navigator.js.map