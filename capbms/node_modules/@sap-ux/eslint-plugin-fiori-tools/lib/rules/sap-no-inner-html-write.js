 ...
 */
import { isIdentifier, isLiteral, isMember } from '../utils/helpers.js';
// ------------------------------------------------------------------------------
// Rule Disablement
// ------------------------------------------------------------------------------
// ------------------------------------------------------------------------------
    ...
    create(context) {
        ...
        return {
            'AssignmentExpression'(node) {
                if (isInteresting(node.left) &&
                    'property' in node.left &&
                    !isValid(node.left.property)) {
...
export default rule;
//# sourceMappingURL=sap-no-inner-html-write.js.map