 ...
 */
function getScalarValue(element, name, ...extraChildNames) {
...
export const getStringValue = (element) => getScalarValue(element, Edm.String);
// Edm.Bool is both the XML attribute name and the CDS-compiled child-element name.
export const getBoolValue = (element) => getScalarValue(element, Edm.Bool);
...
export const getTextPath = (element) => getScalarValue(element, Edm.Path, Edm.PropertyPath);
/**
 ...
 */
export function buildAnnotationEntityTypeMap(parsedService) {
    const map = new Map();
 ...
 */
export function collectRelevantEntityTypes(pages, parsedService) {
 ...
 */
export function parseCommonTextAnnotationKey(annotationKey, relevantEntityTypes) {
