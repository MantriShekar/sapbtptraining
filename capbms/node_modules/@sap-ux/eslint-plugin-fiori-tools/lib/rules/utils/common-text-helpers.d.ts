...
export declare const getStringValue: (element: Element) => string | undefined;
export declare const getBoolValue: (element: Element) => string | undefined;
export declare const getTextPath: (element: Element) => string | undefined;
/**
