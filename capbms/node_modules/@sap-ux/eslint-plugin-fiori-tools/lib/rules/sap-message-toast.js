 ...
 */
import { getIdentifierPath, resolveIdentifierPath, createVariableDeclaratorProcessor, isInteger, endsWith } from '../utils/helpers.js';
...
const rule = {
    ...
    create(context) {
         ...
         */
        function validateDuration(node, property) {
         ...
         * @param property The property to validate
         */
        function validateWidth(node, property) {
            const value = property.value.value;
         ...
         */
        function validatePosition(node, property, name) {
            const value = property.value.value;
...
export default rule;
//# sourceMappingURL=sap-message-toast.js.map