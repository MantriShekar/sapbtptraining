...
const rule = {
    meta: {
        ...
        messages: {
            performanceLimitation: 'A value of more than 0 and less than 300 for the property serviceRefreshIntervall may result in performance limitations.'
        },
        schema: []
    },
    create(context) {
         ...
         */
        function isObjectArgumentValid(argument) {
...
export default rule;
//# sourceMappingURL=sap-bookmark-performance.js.map