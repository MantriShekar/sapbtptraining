 ...
 *
 */
export declare class ApplicationParser {
    private context;
    private index;
    private diagnostics;
    /**
     ...
     * @param fileCache
     */
    parse(projectType: ProjectType, artifacts: FoundFioriArtifacts, fileCache: Map<string, string>): ParseResult;
    /**
     ...
     * @param fileCache - Map of file URIs to their contents
     */
    reparse(uri: string, index: ParsedProject, fileCache: Map<string, string>): ParseResult;
    /**
