import { Edm, getAliasInformation, getAllNamespacesAndReferences, getElementAttribute, getElementAttributeValue, parseIdentifier, toFullyQualifiedName, createAttributeNode, createElementNode } from '@sap-ux/odata-annotation-core';
 ...
 */
export function buildAnnotationIndexKey(target, term) {
    return `${target}/@${term}`;
}
/**
 ...
 */
export function buildServiceIndex(artifacts, documents, v2Annotations = []) {
    const entitySets = {};
