 ...
 */
function linkV4ObjectPageSections(page, path, name, sections, target) {
    linkObjectPageSections(page, path, name, sections.filter((section) => section.type === 'table-section'), target);
 ...
 */
export function runFeV4Linker(context) {
