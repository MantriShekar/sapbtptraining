 ...
 */
export declare function isLowerThanMinimalUi5Version(providedUi5Version: MinUI5Version, minUi5Version: Partial<Pick<MinUI5Version, 'patch'>> & Pick<MinUI5Version, 'major' | 'minor'>): boolean;
