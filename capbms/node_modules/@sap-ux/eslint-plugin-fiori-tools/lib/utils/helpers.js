 ...
 */
export function startsWith(base, sub) {
 ...
 */
export function containsString(str, substring) {
 ...
 */
export function createIsWindowObject(windowObjects) {
 ...
 */
export function createRememberWindow(windowObjects, isWindowObject) {
 ...
 */
export function createIsDocument(isWindowObject) {
 ...
 */
export function createIsDocumentObject(documentObjects, isDocument) {
 ...
 */
export function createRememberDocument(documentObjects, isDocumentObject) {
 ...
 */
export function buildCalleePath(node) {
    const memberNode = node;
 ...
 */
export function getMemberAsString(node) {
    if (isMember(node)) {
        const memberNode = node;
 ...
 */
export function createIsHistory(isWindowObject) {
 ...
 */
export function createIsHistoryObject(historyObjects, isHistory) {
 ...
 */
export function createRememberHistory(historyObjects, isHistoryObject) {
 ...
 */
export function createIsLocation(isWindowObject) {
 ...
 */
export function createIsLocationObject(locationObjects, isLocation) {
 ...
 */
export function createRememberLocation(locationObjects, isLocationObject) {
 ...
 */
export function getLiteralOrIdentifierName(node) {
    if (isIdentifier(node)) {
        return node.name;
    }
    else if (isLiteral(node)) {
 ...
 */
export function getIdentifierPath(node) {
    if (!node) {
        return '';
    }
    const astNode = node;
 ...
 */
export function resolveIdentifierPath(path, variables) {
 ...
 * @param variables The variables lookup object
 */
export function rememberInterestingVariable(node, name, variables) {
 ...
 */
export function checkInterestingPath(path, interestingPathChecker) {
 ...
 */
export function createVariableDeclaratorProcessor(variables, interestingPathChecker) {
 ...
 */
export function hasUnderscore(identifier) {
 ...
 */
export function isForbiddenObviousApi(calleePath) {
 ...
 */
export function createStorageRuleHelpers(storageName, messageId) {
    return {
        /**
 ...
 */
export function createPropertyChecker(propertyGroups) {
 ...
 */
export function findDeepestExistingPath(startObject, pathSegments) {
 ...
 */
export function checkAppTablesConfiguration(page, parsedApp, checkConfiguration) {
    const problems = [];
