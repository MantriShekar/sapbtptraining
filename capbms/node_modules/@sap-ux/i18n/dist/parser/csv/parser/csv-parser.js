...
class ParseCsv {
    ...
    parseField() {
        ...
        return {
            ...
            value: token.value,
            range: Range.create(positionAt(this.lineOffsets, token.start, this.getContentLength()), positionAt(this.lineOffsets, token.end, this.getContentLength()))
        };
    }
    /**
     * Parse CSV row.
            ...
            if (next && next.type !== TokenType.eol) {
                if (next.type === TokenType.separator && this.peek(1) === undefined) {
                    ...
                    row.fields.push({
                        quoted: false,
                        value: '',
                        range: Range.create(positionAt(this.lineOffsets, next.end, this.getContentLength()), positionAt(this.lineOffsets, next.end, this.getContentLength()))
                    });
                }
                this.consume();
            }
