...
function toMaxLength(comment, commaIndex, colonIndex) {
    ...
    return {
        ...
        range: Range.create(start.line, start.character + commaIndex + 1, start.line, start.character + (colonIndex === -1 ? value.length : colonIndex))
    };
}
/**
 ...
 */
export function getAnnotation(commentLine) {
