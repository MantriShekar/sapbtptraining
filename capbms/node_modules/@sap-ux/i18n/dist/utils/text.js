 ...
 */
export function getI18nMaxLength(value) {
 ...
 */
export function getI18nTextType(maxLength) {
    if (maxLength <= 120) {
 ...
 * @returns text
 */
export function discoverLineEnding(text) {
 ...
 */
export function discoverIndent(text) {
 ...
 * @returns indented text
 */
export function applyIndent(text, indent, eol, indentFirstLine = true) {
 ...
 */
export function convertToCamelCase(text = '', maxWord = 4) {
    let output = '';
    const parts = text
        .replace(/[^a-zA-Z0-9 ]/g, '')
        .trim()
 ...
 */
export function convertToPascalCase(text, maxWord = 4) {
    let output = '';
    const parts = text
        .replace(/[^a-zA-Z0-9 ]/g, '')
        .trim()
