 ...
 */
export function resolveCapI18nFolderForFile(root, env, filePath) {
 ...
 * @returns i18n files
 */
export function getCapI18nFiles(root, env, filePaths) {
 ...
 */
export async function getCapI18nFolder(root, path, env, fs) {
    const { folders } = getI18nConfiguration(env);
