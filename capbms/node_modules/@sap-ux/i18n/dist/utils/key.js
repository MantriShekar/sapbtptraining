 ...
 */
export function extractI18nKey(input, key = 'i18n') {
 ...
 */
export function extractDoubleCurlyBracketsKey(input) {
 ...
 * @returns unique key
 */
export function getI18nUniqueKey(key, i18nData, originalKey = key, counter = 1) {
    const uniqueKey = key;
    let keyExists = false;
