...
import { tokenColumn, tokenLine } from './cds-compiler-tokens.js';
/**
 ...
 */
export var DeletionRangeKind;
(function (DeletionRangeKind) {
    DeletionRangeKind["UNDEFINED"] = "Undefined";
    DeletionRangeKind["TERM_NAME"] = "TermName";
    DeletionRangeKind["TERM_FQ_NAME"] = "TermFqName";
    DeletionRangeKind["ANNOTATION"] = "Annotation";
    DeletionRangeKind["TARGET_ELEMENT"] = "TargetElement";
    DeletionRangeKind["TARGET_ELEMENTS_LIST"] = "TargetElementsList";
    DeletionRangeKind["TARGET_PARAMETER"] = "TargetParameter";
    DeletionRangeKind["TARGET_BOUND_ACTION"] = "TargetBoundAction";
    DeletionRangeKind["TARGET_ARTIFACT"] = "TargetArtifact";
    DeletionRangeKind["TARGET_FROM_WITH"] = "TargetFromWith"; // deletion starts from 'with' keyword, i.e. "with @Core.Description: 'description'"
})(DeletionRangeKind || (DeletionRangeKind = {}));
 ...
 */
export function getTextEditsForDeletionRanges(deletionRanges, vocabularyAliases, tokens, annotationFile, includeTarget) {
    let changed;
 ...
 */
export function getDeletionRangeForNode(vocabularyService, vocabularyAliases, termIndex, tokens, annotation, target) {
    if (annotation?.range) {
...
function expandDeletionRanges(vocabularyAliases, tokens, deletionRanges, annotationFile, includeTarget) {
    deletionRanges
        ...
        do {
            ...
            else if (deletionRange.kind === DeletionRangeKind.TERM_FQ_NAME &&
...
function annotationsPresentBefore(position, annotationFile) {
    ...
    return (!!targetOfPreviousAnnotation?.nameRange?.end && isBefore(position, targetOfPreviousAnnotation?.nameRange?.end));
}
/**
