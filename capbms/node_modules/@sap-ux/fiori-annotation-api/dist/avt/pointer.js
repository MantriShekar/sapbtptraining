 ...
 */
export function convertPointerInAnnotationToInternal(annotation, pointer, valueType) {
    // e.g.
...
function handleExpressionValueSegment(currentElement, valueType) {
    ...
    const elementIndex = currentElement.content.findIndex((element) => element.type === ELEMENT_TYPE && element.name === valueType);
    if (elementIndex !== -1) {
