 ...
 */
export async function readExternalServiceMetadata(metadataFilePath, relativeBackendPath, externalServiceDefinitions) {
    ...
    for (const [target, references] of externalServiceDefinitions.entries()) {
        for (const reference of references) {
            for (const value of reference.uris) {
                ...
                const serviceRoot = join(metadataFilePath, '..', relativeServicePath, target
                    .split('/')
