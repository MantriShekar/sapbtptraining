import type { ComplexType, ExpandedComplexType, MarkdownString, ComplexTypeProperty, Term, Vocabulary, VocabularyObject, VocabularyType, EnumValue, CdsVocabulary, TypeDefinition, EnumType } from './types/vocabulary-service.js';
import { TermApplicability } from './types/vocabulary-service.js';
import type { VocabularyAlias } from './resources/index.js';
