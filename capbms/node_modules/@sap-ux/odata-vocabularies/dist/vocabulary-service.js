...
export class VocabularyService {
    ...
    getDefaultAlias(namespace) {
        return NAMESPACE_TO_ALIAS.get(namespace);
    }
    /**
    ...
    getDocumentation(name, propertyName, aliasInfo) {
        ...
        if ((element.kind === COMPLEX_TYPE_KIND || element.kind === PROPERTY_KIND || element.kind === TERM_KIND) &&
    ...
    getFormattedNullableText(object) {
        let sResultText = '';
        const isNullable = (object.kind === TERM_KIND || object.kind === 'Property' || object.kind === TYPE_DEFINITION_KIND) &&
            !!object.facets &&
