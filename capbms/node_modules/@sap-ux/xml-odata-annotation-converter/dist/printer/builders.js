export const line = { type: 'line', hard: false };
export const hardline = { type: 'line', hard: true };
/**
 * Creates Concat.
 *
 * @param parts
 ...
 */
export function indent(content) {
 ...
 */
export function printDocumentToString(document, options) {
