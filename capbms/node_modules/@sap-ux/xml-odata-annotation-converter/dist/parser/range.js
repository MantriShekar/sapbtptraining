 ...
 */
export function transformRange(position) {
    return position
 ...
 * @returns Range where lines and columns start with 0.
 */
export function transformElementRange(position, element) {
 ...
 */
export function getGapRangeBetween(begin, end) {
    if (begin && end) {
 ...
 */
export function adjustRange(range, startColAdjust, endColAdjust, startLineAdjust = 0, endLineAdjust = 0) {
    if (range) {
