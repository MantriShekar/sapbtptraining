...
function rangeAt(lineOffsets, start, end, textLength) {
    return vscode_languageserver_types_1.Range.create((0, position_js_1.positionAt)(lineOffsets, start, textLength), (0, position_js_1.positionAt)(lineOffsets, end, textLength));
}
/**
