...
export class AnnotationParser extends CstParser {
    ...
    CUSTOM_MANY(endToken, repetitionRule) {
        this.MANY(() => {
            ...
            this.OR([
                {
                    GATE: () => this.LA(1).tokenType === tokenMap.Comma &&
                        (this.LA(2).tokenType === endToken || this.LA(2).tokenType === tokenMap.Comma),
                    ALT: () => this.CONSUME2(tokenMap.Comma)
                },
                {
                    GATE: () => this.LA(1).tokenType === tokenMap.Comma && this.LA(2).tokenType !== endToken,
                    ALT: () => {
    ...
    [ASSIGNMENT_TYPE] = this.RULE(ASSIGNMENT_TYPE, () => {
        this.OR([
            {
                GATE: () => this.LA(1).tokenType === tokenMap.Colon,
                ALT: () => {
            ...
            {
                GATE: () => this.LA(1).tokenType === tokenMap.NumberSign,
                ALT: () => {
    ...
    [EXPRESSION_TYPE] = this.RULE(EXPRESSION_TYPE, () => {
        ...
        this.MANY(() => {
            this.OR([
                ...
                {
                    ALT: () => this.CONSUME1(tokenMap.Operator)
                }
            ]);
        });
