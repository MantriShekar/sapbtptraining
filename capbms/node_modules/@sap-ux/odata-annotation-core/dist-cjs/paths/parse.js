...
function parsePath(path) {
    const segments = path
        ...
        if (termCastStartIndex === 0) {
            ...
            const termCastIdentifier = (0, index_js_1.parseIdentifier)(term);
            return {
                ...termCastIdentifier,
                type: 'term-cast',
                qualifier
            ...
            const termCastIdentifier = (0, index_js_1.parseIdentifier)(name);
            const [term, qualifier] = termCast.split('#');
            return {
                ...termCastIdentifier,
                type: 'navigation-property-annotation',
                term: {
                    ...(0, index_js_1.parseIdentifier)(term),
                    type: 'term-cast',
                    qualifier
                }
            };
        }
        const identifier = (0, index_js_1.parseIdentifier)(segment);
