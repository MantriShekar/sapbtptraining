...
function getSegmentWithoutAlias(aliasInfo, segment) {
    ...
    if (indexAt >= 0) {
        const term = (0, index_js_1.resolveName)(segment.substring(indexAt + 1), aliasInfo.aliasMap).qName;
        segmentWithoutAlias = segment.substring(0, indexAt) + '@' + term;
    }
    else if (segment.indexOf('.') > -1) {
        segmentWithoutAlias = (0, index_js_1.resolveName)(segment, aliasInfo.aliasMap).qName;
    }
    else {
