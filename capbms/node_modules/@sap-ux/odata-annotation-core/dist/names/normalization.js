 ...
 */
export function toFullyQualifiedName(namespaceMap, currentNamespace, identifier) {
 ...
 */
export function resolveName(qualifiedName, aliasMap) {
 ...
 */
export function toAliasQualifiedName(qualifiedName, aliasInfo) {
