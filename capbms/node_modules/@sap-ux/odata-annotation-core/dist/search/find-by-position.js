import { createAttributeNode, createTextNode, TARGET_TYPE, NAMESPACE_TYPE, TEXT_TYPE, ELEMENT_TYPE, ATTRIBUTE_TYPE, REFERENCE_TYPE, ANNOTATION_FILE_TYPE, Range, Position } from '@sap-ux/odata-annotation-core-types';
 ...
 */
export function findPathToPosition(annotationFile, position, forCompletion = false) {
 ...
 * @returns
 */
export function getPositionData(annotationFile, positionPointer) {
