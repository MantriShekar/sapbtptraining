 ...
 */
export function mergeObjects(base, extension) {
    return merge({}, base, extension, (objValue, srcValue) => {
 ...
 */
export function getEsmTypesVersion(minUI5Version) {
 ...
 * @returns semantic version representing the types version.
 */
export function getTypesVersion(minUI5Version) {
    const version = semVer.coerce(minUI5Version);
    if (!version) {
        return `~${UI5_DEFAULT.TYPES_VERSION_BEST}`;
    }
 ...
 */
export function getTypesPackage(ui5Version) {
 ...
 */
export function replaceEnvVariables(obj) {
